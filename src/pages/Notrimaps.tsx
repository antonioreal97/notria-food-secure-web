...
interface EstadoProjeto {
  ...
  const estadosComProjetos: EstadoProjeto[] = [
    // Adicione os estados com projetos aqui
    // Exemplo:
    // {
    //   codigo: "PA",
    //   nome: "PARÁ",
    //   coordenadas: { x: 300, y: 200 },
    //   projetos: [
    //     {
...
const NotrimapsPage = () => {
  ...
  // Extrai código do estado do ID (BR-PA -> PA)
  const extrairCodigoEstado = (id: string) => {
    return id.replace('BR-', '');
  };

  // Cores para estados com projetos
  const getEstadoColor = (id: string) => {
    const codigo = extrairCodigoEstado(id);
  ...
  const handleEstadoClick = (id: string) => {
    ...
    if (estado) {
      ...
      // Limpa a seleção ao clicar em estado sem projetos
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO 
        title="Notrimaps - Projetos da Notriá pelo Brasil | Notriá Consultoria"
        description="Explore os estados onde a Notriá já entregou projetos em Segurança Alimentar e Nutricional. Conheça nosso impacto pelo Brasil."
        keywords="notrimaps, projetos notria, segurança alimentar brasil, projetos SAN, consultoria segurança alimentar estados brasileiros"
        url="/notrimaps"
      />
      <Header />
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <AnimatedSection {...(!isMobile ? {animation: 'slide-up', delay: 200, duration: 500} : {})}>
              <div className="text-center mb-12">
                <h1 className="font-poppins font-bold text-4xl md:text-5xl text-notria-primary mb-6">
                  Notrimaps
                </h1>
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start">
              ...
              >
                <div className="bg-notria-light rounded-xl p-6 lg:p-8 shadow-lg relative">
                  <div className="relative w-full" style={{ aspectRatio: '612.51611/639.04297' }}>
                    {/* Mapa SVG do Brasil - SVG real */}
                    <svg
                    ...
                    >
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-AC")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-AC") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-AC")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-RO")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-RO") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-RO")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-AM")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-AM") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-AM")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-RR")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-RR") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-RR")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-AP")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-AP") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-AP")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-PA")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className="cursor-pointer hover:opacity-80 transition-opacity"
                        onClick={() => handleEstadoClick("BR-PA")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-TO")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-TO") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-TO")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-MA")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-MA") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-MA")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-PI")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-PI") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-PI")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-CE")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-CE") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-CE")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-RN")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-RN") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-RN")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-PB")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-PB") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-PB")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-PE")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-PE") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-PE")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-AL")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-AL") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-AL")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-SE")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-SE") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-SE")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-BA")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-BA") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-BA")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-MT")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-MT") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-MT")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-MS")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-MS") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-MS")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-GO")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-GO") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-GO")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-DF")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-DF") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-DF")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-MG")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-MG") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-MG")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-ES")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-ES") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-ES")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-RJ")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-RJ") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-RJ")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-SP")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-SP") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-SP")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-PR")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-PR") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-PR")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-SC")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-SC") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-SC")}
                      />
                      ...
                      <path
                        ...
                        fill={getEstadoColor("BR-RS")}
                        stroke="#fff"
                        strokeWidth="1.5"
                        className={temProjetos("BR-RS") ? "cursor-pointer hover:opacity-80 transition-opacity" : ""}
                        onClick={() => handleEstadoClick("BR-RS")}
                      />
