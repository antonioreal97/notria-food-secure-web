    ...
    <section id="inicio" className="bg-gradient-to-br from-notria-primary via-notria-primary to-notria-secondary min-h-screen flex items-center">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center text-white mt-16">
          ...
          <AnimatedSection {...(!isMobile ? {animation: 'fade-in', delay: 400, duration: 500} : {})}>
          ...
          <AnimatedSection {...(!isMobile ? {animation: 'slide-up', delay: 800, duration: 500} : {})}>
          ...
          <AnimatedSection {...(!isMobile ? {animation: 'bounce-in', delay: 1000, duration: 500} : {})}>
